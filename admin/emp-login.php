        ...
        <div class="main-content container-fluid">
          <div class="splash-container">
            <div class="card card-border-color card-border-color-danger">
              <div class="card-header"><img class="logo-img" src="assets/img/logo-xx.png" alt="logo" width="150px" height="150px"><span class="splash-description">Admin Login Panel</span></div>
              <div class="card-body">
