        ...
        <div class="main-content container-fluid">
          <div class="splash-container">
            <div class="card card-border-color card-border-color-success">
              <div class="card-header"><img class="logo-img" src="assets/img/logo-xx.png" alt="logo" width="150px" height="150px"><span class="splash-description">Please enter your user information.</span></div>
              <div class="card-body">
            ...
            <div class="splash-footer">&copy; 2019 - <?php echo date ('Y');?> Bayan University Graduation Project  </div>
          </div>
        </div>
      </div>
    </div>
